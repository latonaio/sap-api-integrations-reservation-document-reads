...
import (
	...
	sap_api_input_reader "sap-api-integrations-reservation-document-reads/SAP_API_Input_Reader"
	"sap-api-integrations-reservation-document-reads/config"
...
func main() {
	...
	inputSDC := fr.ReadSDC("./Inputs/SDC_Reservation_Document_Item_sample.json")
	...
	caller.AsyncGetReservationDocument(
		inputSDC.Reservation.Reservation,
		inputSDC.Reservation.ReservationItem.RecordType,
		inputSDC.Reservation.ReservationItem.Product,
		accepter,
	)
}
